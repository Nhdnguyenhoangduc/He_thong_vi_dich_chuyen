...
graph TD
    ...
    subgraph PC["Máy tính – Python (vision_pipeline.py)"]
...
│
├── src/
│   └── vision_pipeline.py      ← Toàn bộ pipeline Python (1 138 dòng)
│
├── arduino/
│   └── stepper_controller/
│       └── stepper_controller.ino   ← Firmware ATmega328P (ISR + ACK)
│
├── tests/
...
1. Mở `arduino/stepper_controller/stepper_controller.ino` trong Arduino IDE
2. Chọn board **Arduino Uno** + đúng cổng COM
3. Upload

---

## ⚙️ Cấu hình chính (`src/vision_pipeline.py`)
